...
<html lang="en">
<head>
<script rel="prefetch" type="text/javascript" src="https://unpkg.com/wangeditor/dist/wangEditor.min.js"></script>
    <meta charset="utf-8">
                    ...
                    <?php
                            ...
                            if ($total_pages == 1 or $total_pages == 0) {
                                ...
                                if ($page == 1) {
                                    for ($i=1; $i <= 3; $i++) { 
                                        if ($i == $page) {
                                            echo "<a href='lastest.php?page=$i' style='color:#198754'>$i</a>";
                                        }else {
                                            echo "<a href='lastest.php?page=$i'>$i</a>";
                                        }
                                    if ($i == $total_pages) {
                                        break;
                                    }
                                    ...
                                    echo "<a href='lastest.php?page=1'>1</a>";
                                    for ($i=2; $i < 5; $i++) { 
                                        if ($i == $page) {
                                            echo "<a href='lastest.php?page=$i' style='color:#198754'>$i</a>";
                                        }else {
