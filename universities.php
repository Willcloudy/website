                ...
                <div class="box" >
                    <form action="universities.php" method="POST">
                        <span>
                            ...
                            <input class='form-control search' type="text" name='searchcontent' placeholder='搜索你心仪大学(中英文名字都可)' style='width:80%;padding:2%;border-radius:15px 0px 0px 15px;'required='required'/>
                            <button class='uni-search-btn' 
                                style='position:relative;left:490px;top:-34px;height:34px;
                                border:2px solid #00BFFF;background-color:white;font-weight:bold;color:#00BFFF;border-radius:0 15px 15px 0;font-size:1.1em'>
                    ...
                    <?php
                        if (isset($_POST['searchcontent'])) {
                            ...
                            echo '<hr><h4 style="font-weight:bold;text-align:center">搜索"'.$input.'"的结果</h4>';
                        ...
                        }elseif (isset($_POST['selectednation'])) {
                            if ($_POST['selectednation'] == '请选择一个国家') {
                                echo '
                            <hr>';
                            ...
                            <div class='col-md-13'>
                                ...
                                $input = $_POST['selectednation'];
                            echo '<hr><h4 style="font-weight:bold;text-align:center">所有在'.$input.'的学校</h4>';
                            $recommend_query = "SELECT * FROM `university` where uni_country like '%$input%'";
                            if (!$run_recommend = mysqli_query($con, $recommend_query)) {
